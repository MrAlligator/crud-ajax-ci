                        ...
                        <div class="row">
                            <div class="col-lg">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?= base_url('auth/siswa_login') ?>" method="POST">
                                        <input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>" style="display: none;">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="username" id="username" placeholder="Masukkan NIS" onkeypress="return hanyaAngka(event)"><?= form_error('username', '<small class="text-danger pl-3">', '</small>') ?>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <a href="<?= base_url('auth') ?>" class="btn btn-info btn-user btn-block">Masuk Sebagai Admin</a>
                                    </form>
                                    <hr>
                                    &nbsp;
